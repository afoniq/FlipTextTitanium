...
// in simulator we redefine to format for fliptext Developer console
...
{\
	NSString * exceptionName = [@"org.fliptext." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fliptext";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIfliptextNativeItemNone = -1, 
	UIfliptextNativeItemSpinner = -2,
	UIfliptextNativeItemProgressBar = -3,
	
	UIfliptextNativeItemSlider = -4,
	UIfliptextNativeItemSwitch = -5,
	UIfliptextNativeItemMultiButton = -6,
	UIfliptextNativeItemSegmented = -7,
	
	UIfliptextNativeItemTextView = -8,
	UIfliptextNativeItemTextField = -9,
	UIfliptextNativeItemSearchBar = -10,
	
	UIfliptextNativeItemPicker = -11,
	UIfliptextNativeItemDatePicker = -12,
	
	UIfliptextNativeItemInfoLight = -13,
	UIfliptextNativeItemInfoDark = -14,
	
	UIfliptextNativeItemDisclosure = -15,
	
	UIfliptextNativeItemContactAdd = -16
};
